import { User, GoogleAuthProvider, getAuth, onAuthStateChanged, signInWithPopup, signOut } from 'firebase/auth';
...
const NavBar = () => {
    ...
    const [userData, setUserData] = useState<User| null>(inittialUserData);
...
const NavWraper = styled.nav<{show:boolean}>`
    position : fixed;
    top: 0;
    left : 0;
    right : 0;
